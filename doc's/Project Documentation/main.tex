...
\textbullet{ The first feature is the register page which needs the user needs to submit their name and a clear frontal picture of themselves. These details are then saved to the database.}
